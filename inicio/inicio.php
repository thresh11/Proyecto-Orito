...
<div class="menuR">
    ...
    <section class="section_targeta_publicitaria">
        ...
        <p>En Orito Verde estamos comprometido con el ambiente así que por cada caja 
            de brownie que compres destinamos un recurso para la siembra de arboles en 
            los diferentes territorios del departamento Tolima, nuestra meta es tan grande 
            como el compromiso y el amor que le ponemos a nuestros productos así que por cada 
            1000 cajas vendidas sembraremos 50 árboles. Recuerda que cada vez que disfrutas un 
            brownie estás aportando a nuestra campaña de reforestación un granito de arena 
            esencial para la salud del planeta, la conservación de la biodiversidad, la estabilidad climática, la protección del suelo y el agua, así como para el bienestar y el sustento de todos y todas, si así de grande es el impacto que podemos tener. </p>
    </section>
